...
function Card(cardData: CardData) {
    ...
    return (
        ...
        >
            <h2 className="font-semibold text-lg mb-2 group-hover: transition-colors duration-200">
                {cardData.title}
            </h2>
            ...
            <span className="inline-block mt-4 text-xs font-medium tracking-wide uppercase">
                View project →
            </span>
        </Link>
    )
